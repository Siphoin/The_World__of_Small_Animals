...
using System.Linq;
    ...
    {
        // This constant is used to determine the KEY_SIZE of the encryption algorithm in bits.
        // We divide this by 8 within the code below to get the equivalent number of bytes.
        private const int KEY_SIZE = 256;

    private const string KEY = "mygD%]YGh/G@Y>[/n!T.?):X-F#rvXA8aL:eQQ,A&?x/ZlcPZ`";
